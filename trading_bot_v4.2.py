...
async def on_ready():
    ...
    if channel:
        ...
        await channel.send(
            f"```\n🤖 Trading Bot v4.2 Ultra Pro démarré !\n\n"
...
async def cmd_aide(ctx):
    await ctx.send(
        "```\n📖 COMMANDES\n\n"
        "!analyse [SYMBOL] → Signal complet (ex: !analyse NVDA)\n"
...
if __name__ == "__main__":
    ...
    logger.info("Démarrage Trading Bot v4.2 Ultra Pro...")
