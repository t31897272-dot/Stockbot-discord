...
async def analyze_and_send(symbol, channel, force=False):
    try:
        ...
        action_4h = "BUY" if confidence >= 0.65 else ("SELL" if confidence <= 0.45 else "HOLD")
...
async def on_ready():
    ...
    if channel:
        ...
        await channel.send(
            f"```\n🤖 Trading Bot v4.5 Ultra Pro démarré !\n\n"
...
if __name__ == "__main__":
    ...
    logger.info("Démarrage Trading Bot v4.5 Ultra Pro...")
